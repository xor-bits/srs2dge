...
/// Takes in `DefaultVertex` VBO
///
/// Takes in an UBO with "mat" -> Mat4x4 MVP matrix
pub fn color_2d_program<F>(facade: &F) -> Program
where
    F: Facade,
{
...
/// Takes in an UBO with "mat" -> Mat4x4 MVP matrix
///
/// Takes in texture2D sampler
pub fn texture_2d_program<F>(facade: &F) -> Program
where
    F: Facade,
{
    glium::program!(facade,
